...
export const registerOutlineButtonClass =
  "h-9 bg-background px-3 shadow-none [&_svg]:text-[#a57b3d]";
...
export function DataRegisterEmptyState({
  ...
  return (
    ...
    >
      <span className="flex size-11 items-center justify-center rounded-full border border-[#cbbda9]/55 bg-[#fbf8f2] text-[#a57b3d] shadow-sm dark:bg-white/[0.05]">
