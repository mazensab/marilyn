"use client";
// accounting_financial_center_hr_spirit=true
// accounting_shared_financial_tabs=true
// accounting_financial_inner_cards_hr_spirit=true
/* ============================================================
   📂 marilyn_frontend/app/system/accounting/_components/accounting-center-client.tsx
   🧠 Marilyn Clinics — System General Accounting Center
   ------------------------------------------------------------
   ✅ Approved Premium company/system dashboard pattern
   ✅ Real API only, no fake demo data
   ✅ Central medical facility overview
   ✅ Read-only dashboard page
   ✅ Operational links to the existing accounting workspace
   ✅ Excel .xls + Web print
   ✅ Skeleton loading
   ✅ Error / Empty states
   ✅ sonner toast
...
const translations = {
  ar: {
    ...
    subtitle:
      "لوحة متابعة مالية للمنشأة الطبية تعرض الحسابات، القيود، الأرصدة، وملخصات التقارير المحاسبية من مكان واحد.",
    moduleBadge: "الإدارة المركزية",
    refresh: "تحديث",
    export: "تصدير Excel",
    print: "طباعة",
    reset: "إعادة ضبط",
    ...
    latestEntriesDesc: "أحدث القيود المحاسبية للمنشأة الطبية.",
    ...
    errorDesc: "تأكد من تسجيل الدخول وتشغيل الباكند ثم أعد المحاولة.",
  ...
  en: {
    ...
    subtitle:
      "A financial dashboard for the medical facility accounts, journal entries, balances, and accounting reports in one place.",
    moduleBadge: "Central administration",
    refresh: "Refresh",
    export: "Export Excel",
    print: "Print",
    reset: "Reset",
    ...
    latestEntriesDesc: "Newest medical facility accounting journal entries.",
    ...
    errorDesc: "Make sure you are signed in and the backend is running, then try again.",
    tryAgain: "Try again",
...
function KpiCard({
  ...
  return (
    <SystemKpiCard
      title={title}
      value={money ? formatMoney(value) : formatInteger(value)}
      description={description}
      href={href}
      icon={icon}
      currencyIcon={money}
...
function EmptyTableState({
  ...
  return (
    <div className="flex h-full min-h-64 flex-col items-center justify-center gap-3 px-6 py-10 text-center">
      ...
      {showReset && onReset ? (
        <Button type="button" variant="outline" size="sm" className={registerOutlineButtonClass} onClick={onReset}>
    ...
    <div className="flex flex-col gap-3 rounded-lg border bg-muted/20 p-3 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Select value={sort} onValueChange={(value) => onSortChange(value as SortKey)}>
          <SelectTrigger className="h-9 rounded-lg bg-background sm:w-[160px]"><ArrowUpDown className="h-4 w-4 text-[#a57b3d]" /><SelectValue /></SelectTrigger>
          <SelectContent>
        ...
        <Button type="button" variant="outline" className={registerOutlineButtonClass} onClick={onReset}>
    ...
    <div className="space-y-3">
      <div className="overflow-hidden rounded-lg border bg-background">
        <div className="overflow-x-auto">
          <Table variant="register" className="min-w-[960px] table-fixed">
            <TableHeader>
...
export default function AccountingCenterClient() {
  ...
  const kpiCards = [
    ...
    },
    {
      ...
      description: locale === "ar" ? "التزامات المنشأة" : "Medical facility obligations",
      href: "/company/accounting/balance-sheet",
      icon: ArrowDownLeft,
      money: true,
    },
  ...
  function exportExcel() {
    ...
    downloadExcelReport(
      "marilyn-system-accounting-dashboard.xls",
      t.printTitle,
      filteredEntries,
      true,
    );
  ...
  function exportEntriesExcel() {
    ...
    anchor.href = url;
    anchor.download =
      "marilyn-system-journal-entries.xls";
  ...
  if (error) {
    return (
      <main dir={dir} className="text-foreground">
        <Card className="rounded-lg border-destructive/30 shadow-sm">
          <CardHeader>
        ...
        <header className="flex w-full flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0 max-w-5xl text-start">
            <div className="mb-2 flex items-center gap-2 text-xs font-medium text-[#9a7139]">
              <BookOpen className="h-3.5 w-3.5 text-[#a57b3d]" />
              {t.moduleBadge}
            </div>
            ...
            <p className="mt-3 flex items-center gap-2 text-xs text-muted-foreground">
              ...
              {locale === "ar"
                ? "متصل بواجهات الحسابات والقيود والأرصدة والتقارير الحقيقية"
                : "Connected to live accounts, journals, balances, and reports APIs"}
            </p>
          </div>
          ...
          <Card className="rounded-lg border bg-card shadow-none">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base font-bold tracking-tight">
                <BookOpen className="h-4 w-4 text-[#a57b3d]" />
                {t.shortcutsTitle}
              </CardTitle>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex min-w-0 items-start gap-3">
                        <span className="flex size-10 shrink-0 items-center justify-center rounded-full border border-[#cbbda9]/55 bg-[#fbf8f2] text-[#a57b3d] shadow-sm transition group-hover:border-[#b58c4d]/70 group-hover:bg-[#f7f0e4]">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-lg border bg-background p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="flex size-10 shrink-0 items-center justify-center rounded-full border border-[#cbbda9]/55 bg-[#fbf8f2] text-[#a57b3d] shadow-sm">
          ...
          <CardHeader className="px-5 pt-5 sm:px-6">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0 text-start">
                <CardTitle className="flex items-center gap-2 text-base font-bold tracking-tight">
                  <Calculator className="h-4 w-4 text-[#a57b3d]" />
                  {t.latestEntries}
                </CardTitle>
