...
/* ============================================================
   ...
   ✅ Real API only: /api/system/whatsapp/connection/
   ✅ System WhatsApp connection/settings/QR/pairing/test
...
const translations = {
  ...
  en: {
    ...
    subtitle:
      "Standalone page for the official system WhatsApp number, connection, QR, pairing code, webhook, and test message.",
    badge: "Communication",
    refresh: "Refresh",
    save: "Save settings",
    print: "Print",
    ...
    pageLinksTitle: "System WhatsApp pages",
    ...
    actionsDesc: "Real connection operations for the system WhatsApp number.",
    ...
    settingsTitle: "System WhatsApp connection details",
    settingsDesc: "These details belong to the official system WhatsApp and do not mutate company settings.",
    provider: "Provider",
    ...
    loadError: "Failed to load system WhatsApp settings.",
    saveSuccess: "System WhatsApp settings saved.",
    saveError: "Failed to save system WhatsApp settings.",
    actionError: "Action failed.",
    refreshed: "System WhatsApp connection refreshed.",
    ...
    tryAgain: "Try again",
    errorTitle: "Failed to load system WhatsApp settings",
  },
} as const;
