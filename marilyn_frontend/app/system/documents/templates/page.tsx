/* ============================================================
   📂 marilyn_frontend/app/system/documents/templates/page.tsx
...
export default function SystemDocumentTemplatesPage() {
  return <SystemDocumentsCenter mode="templates" />;
}
