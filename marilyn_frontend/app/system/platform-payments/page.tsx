...
/* ============================================================
   📂 marilyn_frontend/app/system/platform-payments/page.tsx
...
const translations = {
  ar: {
    ...
    actionsTitle: "اختصارات مدفوعات المنصة",
    actionsDesc: "تنقل سريع بين صفحات مدفوعات المنصة الأساسية بنفس نمط إدارة المنصة.",
    openListTitle: "عرض قائمة المدفوعات",
    openListDesc: "جدول كامل لإيصالات دفع المنصة مع الفلاتر والتصدير والطباعة.",
    createTitle: "قائمة المدفوعات",
    createDesc: "عرض إيصالات الدفع وربطها بمستندات فوترة المنصة.",
    reportsTitle: "تقارير المدفوعات",
    reportsDesc: "تحليل إيصالات الدفع حسب الحالة وطريقة الدفع والمبالغ.",
    dashboardTitle: "لوحة النظام",
    dashboardDesc: "العودة إلى لوحة تحكم النظام الرئيسية.",

    tableTitle: "أحدث إيصالات الدفع",
    tableDesc:
      "نظرة سريعة على أحدث إيصالات دفع المنصة مع الشركة والمبلغ وطريقة الدفع.",
    company: "الشركة",
    code: "رقم الإيصال",
    owner: "مرجع الفوترة",
    ...
    errorTitle: "تعذر تحميل مركز مدفوعات المنصة",
    errorDesc:
    ...
    of: "من",
    rows: "صفوف",
    refreshed: "تم تحديث مركز مدفوعات المنصة.",
  },
  en: {
    ...
    subscribedCompanies: "Fully paid",
    fromLiveApi: "From real system APIs",

    actionsTitle: "Platform payments shortcuts",
    actionsDesc: "Quick navigation between companies pages using the platform management pattern.",
    openListTitle: "Open payments list",
    openListDesc: "Full platform payment receipts table with filters, export, and print.",
    ...
    reportsDesc: "Analyze payment receipts by status, payment method, and amounts.",
    ...
    errorTitle: "Could not load platform payments center",
    errorDesc:
    ...
    of: "of",
    rows: "rows",
    refreshed: "Platform payments center refreshed.",
  },
} as const;
