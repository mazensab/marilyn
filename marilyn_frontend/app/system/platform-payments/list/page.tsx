...
/* ============================================================
   📂 marilyn_frontend/app/system/platform-payments/list/page.tsx
   💳 Mhamcloud — System Platform Payments List
   ------------------------------------------------------------
...
const translations = {
  ar: {
    title: "قائمة مدفوعات المنصة",
    subtitle:
      "إدارة ومراجعة إيصالات دفع المنصة في Mhamcloud مع البحث والفلاتر والتصدير والطباعة وملف PDF.",
    refresh: "تحديث",
    exportExcel: "تصدير Excel",
    print: "طباعة",
    pdf: "PDF",
    addCompany: "مركز المدفوعات",
    reset: "إعادة ضبط",
    searchPlaceholder: "ابحث باسم الشركة أو رقم الإيصال أو مرجع الفوترة أو طريقة الدفع...",
    status: "الحالة",
    all: "الكل",
    from: "من",
    to: "إلى",
    ...
    totalCompanies: "إجمالي الإيصالات",
    activeCompanies: "الإيصالات الصادرة",
    inactiveCompanies: "ملغاة",
    subscribedCompanies: "مدفوعة بالكامل",
    filteredRows: "النتائج المعروضة",
    fromLiveApi: "من واجهات النظام الحقيقية",

    tableTitle: "قائمة مدفوعات المنصة",
    tableDesc:
      "جدول موحد كامل العرض يعرض إيصالات دفع المنصة مع الشركة والمبلغ وطريقة الدفع والمراجع والحالة وتاريخ الإنشاء.",
    company: "الشركة",
    code: "رقم الإيصال",
    owner: "مرجع الفوترة",
    ...
    noDataTitle: "لا توجد مدفوعات منصة بعد",
    noDataDesc: "ستظهر إيصالات دفع المنصة هنا عند توفرها من API.",
    ...
    of: "من",
    rows: "صفوف",
    refreshed: "تم تحديث قائمة مدفوعات المنصة.",
  },
  en: {
    title: "Platform payments list",
    subtitle:
    ...
    totalCompanies: "Total receipts",
    activeCompanies: "Issued receipts",
    inactiveCompanies: "Cancelled",
    subscribedCompanies: "With value",
    filteredRows: "Filtered rows",
    fromLiveApi: "From real system APIs",

    tableTitle: "Platform payments list",
    tableDesc:
      "A unified full-width table showing platform payment receipts with company, paid amount, payment method, references, status, and issue date.",
    company: "Company",
    code: "Code",
    ...
    noDataTitle: "No platform payments yet",
    noDataDesc: "Platform payment receipts will appear here when returned by the API.",
    ...
    of: "of",
    rows: "rows",
    refreshed: "Platform payments list refreshed.",
  },
} as const;
...
function extractArray(payload: unknown): unknown[] {
  ...
  if (Array.isArray(record.billing_documents)) return record.billing_documents;
  ...
  if (Array.isArray(dataRecord.documents)) return dataRecord.documents;
  if (Array.isArray(dataRecord.billing_documents)) return dataRecord.billing_documents;
  ...
  if (Array.isArray(resultRecord.documents)) return resultRecord.documents;
  if (Array.isArray(resultRecord.billing_documents)) return resultRecord.billing_documents;
...
export default function SystemPlatformPaymentsListPage() {
                        ...
                        <TableRow key={company.id || company.code || company.name} className="h-[68px]">
                          ...
                          <TableCell className="sticky left-0 z-10 h-[68px] bg-background px-3 text-center align-middle">
                            <Button asChild variant="outline" size="sm" className="h-8 rounded-lg bg-background px-3">
                              <Link href={company.id ? `/system/platform-payments/${company.id}` : "/system/platform-payments"}>
                                {t.open}
                              </Link>
                            </Button>
                          </TableCell>
