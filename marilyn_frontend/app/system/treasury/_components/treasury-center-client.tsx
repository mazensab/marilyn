"use client";
// treasury_financial_center_hr_spirit=true
// treasury_shared_financial_tabs=true
// treasury_financial_inner_cards_hr_spirit=true
/* ============================================================
   📂 marilyn_frontend/app/system/treasury/_components/treasury-center-client.tsx
   🧠 Marilyn Clinics — System Treasury & Payments Center
   ------------------------------------------------------------
   ✅ Approved Premium company dashboard pattern
   ✅ Real API only, no fake demo data
   ✅ Central medical facility treasury overview
...
const shortcuts: ShortcutRecord[] = [
  {
    href: "/system/treasury?view=accounts&type=CASH",
  ...
  {
    href: "/system/treasury?view=accounts&type=BANK",
  ...
  {
    href: "/system/treasury?view=transactions",
    titleAr: "سجل الحركات",
...
const translations = {
  ar: {
    ...
    latestAccountsDesc: "أحدث حسابات الصندوق والبنك والمحفظة للمنشأة الطبية.",
  ...
  en: {
    ...
    latestAccountsDesc: "Newest cash, bank, and wallet accounts for the medical facility.",
...
function EmptyTableState({
  ...
  return (
    <div className="flex h-full min-h-64 flex-col items-center justify-center gap-3 px-6 py-10 text-center">
      ...
      {showReset && onReset ? (
        <Button variant="outline" size="sm" className={registerOutlineButtonClass} onClick={onReset}>
    ...
    <div className="space-y-3">
      <div className="overflow-hidden rounded-lg border bg-background">
        <div className="overflow-x-auto">
          <Table variant="register" className="min-w-[1080px] table-fixed">
            <TableHeader>
...
export default function TreasuryCenterClient() {
  ...
  const kpiCards = [
    ...
    },
    {
      ...
      href: "/system/treasury?view=transactions&type=INFLOW",
      icon: ArrowDownLeft,
      money: true,
    },
    {
      ...
      href: "/system/treasury?view=transactions&type=OUTFLOW",
      icon: ArrowUpRight,
      money: true,
    },
    {
        ...
        <header className="flex w-full flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0 max-w-5xl text-start">
            ...
            <p className="mt-3 flex items-center gap-2 text-xs text-muted-foreground">
              ...
              {locale === "ar"
                ? "متصل بواجهات أرصدة الخزينة والحسابات والحركات الحقيقية"
                : "Connected to live treasury balances, accounts, and transactions APIs"}
            </p>
          </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-lg border bg-background p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="flex size-10 shrink-0 items-center justify-center rounded-full border border-[#cbbda9]/55 bg-[#fbf8f2] text-[#a57b3d] shadow-sm"><ShieldCheck className="h-4 w-4" /></span>
                  </div>
                ...
                <div className="rounded-lg border bg-background p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="flex size-10 shrink-0 items-center justify-center rounded-full border border-[#cbbda9]/55 bg-[#fbf8f2] text-[#a57b3d] shadow-sm"><FileText className="h-4 w-4" /></span>
                  </div>
                ...
                <div className="rounded-lg border bg-background p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="flex size-10 shrink-0 items-center justify-center rounded-full border border-[#cbbda9]/55 bg-[#fbf8f2] text-[#a57b3d] shadow-sm"><CheckCircle2 className="h-4 w-4" /></span>
                  </div>
                ...
                <div className="rounded-lg border bg-background p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="flex size-10 shrink-0 items-center justify-center rounded-full border border-[#cbbda9]/55 bg-[#fbf8f2] text-[#a57b3d] shadow-sm"><TriangleAlert className="h-4 w-4" /></span>
                  </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex flex-col gap-3 rounded-lg border bg-muted/20 p-3 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Button variant="outline" className={registerOutlineButtonClass} onClick={resetAccountFilters}>
                  <RotateCcw className="h-4 w-4" />
                  {t.reset}
                </Button>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex flex-col gap-3 rounded-lg border bg-muted/20 p-3 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Button variant="outline" className={registerOutlineButtonClass} onClick={resetTransactionFilters}>
                  <RotateCcw className="h-4 w-4" />
                  {t.reset}
                </Button>
              </div>
